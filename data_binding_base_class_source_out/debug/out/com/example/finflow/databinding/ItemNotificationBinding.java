...
public final class ItemNotificationBinding implements ViewBinding {
  ...
  private ItemNotificationBinding(@NonNull CardView rootView,
      @NonNull ImageView btnDeleteNotification, @NonNull ImageView ivNotificationIcon,
      @NonNull LinearLayout notificationContainer, @NonNull TextView tvNotificationMessage,
  ...
  public static ItemNotificationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNotificationBinding((CardView) rootView, btnDeleteNotification,
          ivNotificationIcon, notificationContainer, tvNotificationMessage, tvNotificationTime,
          tvNotificationTitle);
    }
